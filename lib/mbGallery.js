...
jQuery.fn.mbGallery = function(NewOptions)
{
	return this.each(function() {
		...
		//thumbnail navigator
		$(thumbBox).prepend("<div class='header'><table cellpadding='0' cellspacing='0'><td class='thumbWinBtn pointer' ></td><td class='spacer' ></td><td class='slideShow pointer' ></td><td class='spacer' ></td><td class='prev pointer' ></td><td class='next pointer' ></td><td class='spacer' ></td><td class='loader'></td><td class='indexLabel' nowrap></td><td class='spacer' ></td><td class='closeBtn pointer' >X</td></div>");
		...
		var closeBtn = $(header).find(".closeBtn");
